                ...
                .then(
                        Flux.just(data.stream()
                                ...
                                .map(field -> Creature.builder()
                                        ...
                                        .moveSpeed(Integer.valueOf((String) field.get(4)))
                                        .hpHead(Integer.valueOf((String) field.get(5)))
                                        .hpBody(Integer.valueOf((String) field.get(6)))
                                        .hpArms(Integer.valueOf((String) field.get(7)))
                                        .hpLegs(Integer.valueOf((String) field.get(8)))
                                        .build())
                                .collectList()
